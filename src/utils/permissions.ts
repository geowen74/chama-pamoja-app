...
export const ROLE_PERMISSIONS: Record<UserRole, Permission[]> = {
  ...
  vice_chairman: [
    ...
    'view_projects', 'add_projects', 'edit_projects',
    'view_fines', 'add_fines',
    'view_reports', 'export_reports',
    'view_settings',
  ],
  ...
  treasurer: [
    'view_members',
    'view_contributions', 'add_contributions', 'edit_contributions', 'confirm_contributions',
    'view_loans', 'apply_loan', 'disburse_loans', 'record_repayments',
    'view_meetings', 'record_attendance',
    'view_expenses', 'add_expenses', 'edit_expenses',
    'view_projects', 'edit_projects',
    'view_fines', 'add_fines', 'edit_fines',
    'view_reports', 'export_reports',
    'view_settings', 'manage_contribution_types', 'manage_loan_types', 'manage_fine_types',
  ],
  
  vice_treasurer: [
    'view_members',
    'view_contributions', 'add_contributions', 'edit_contributions',
    'view_loans', 'apply_loan', 'record_repayments',
    'view_meetings',
  ...
  secretary: [
    'view_members', 'add_members', 'edit_members',
    'view_contributions', 'add_contributions', 'confirm_contributions',
    'view_loans', 'apply_loan', 'approve_loans', 'reject_loans',
    'view_meetings', 'schedule_meetings', 'edit_meetings', 'delete_meetings', 'record_attendance',
    'view_expenses', 'add_expenses',
    'view_projects', 'add_projects', 'edit_projects',
    'view_fines', 'add_fines',
  ...
  vice_secretary: [
    ...
    'view_contributions',
    'view_loans', 'apply_loan',
    'view_meetings', 'schedule_meetings', 'record_attendance',
    'view_expenses',
    'view_projects',
    'view_fines',
    'view_reports',
